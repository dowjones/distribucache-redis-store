...
RedisStore.prototype.getProp = function (key, field, cb) {
  this._client.hget(this._getKey(key), field, cb);
};

RedisStore.prototype.setProp = function (key, field, value, cb) {
  this._client.hset(this._getKey(key), field,
    value, errorOrNothing(cb));
};

RedisStore.prototype.incrPropBy = function (key, field, value, cb) {
  this._client.hincrby(this._getKey(key), field, value, cb);
};

RedisStore.prototype.delProp = function (key, field, cb) {
